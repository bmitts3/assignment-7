...
let favoriteFoods = ["BBQ", "Sushi", "Tacos", "Chicken", "Burgers", "Alfredo"];
...
// ...etc.
console.log("My favorite foods ranked");
...
printFoodRecommendation("Alfredo");
printFoodRecommendation("BBQ");
